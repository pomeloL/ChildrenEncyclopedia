        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading) {
                    Text("注：点击国旗可以朗读，点击文字可以查看详情")
                        .foregroundColor(.pink)
                        .padding([.bottom], 10)
                    Text("这是一个世界各国列表，列表展示出各个国家的国旗和首都。所有数据来源于：维基百科和中华人民共和国外交部🙏")
                    Text("划分国家的政治标准")
                        .underline(true, color: Color.pink)
                        .font(.title3)
                        .padding(.vertical,4)
                        .padding([.top], 15)
                    Text("本列表来自于1933年《蒙特维多国家权利义务公约》对主权国家的定义。根据该公约，一个主权国家有如下的标准：⑴永久的人口，⑵固定的领土，⑶有效的政府，以及⑷与他国交往的能力。最后一点是一个政治实体被其他国家承认为一个主权国家决定性的因素，因为这表示其为国际社会所接受,根据以上标准，本表收录了208个政治实体：")
                        .padding(.vertical,2)
                    Text("    - 195个为联合国系统：")
                    Text("        - 其中193国为联合国会员国。")
